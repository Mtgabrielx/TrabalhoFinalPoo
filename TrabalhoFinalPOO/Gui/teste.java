...
public class teste {
	...
	private void initialize() {
		...
		frmCampeonatoDeArco.setBounds(100, 100, 500, 300);
                            ...
                            // consulta um jogador pelo seu ID
                              ...
                              consultar.addActionListener(new ActionListener() {
                                                  				...
                                                  				try {
                                                  					...
                                                  					lesionadoCheck.setSelected(procurado.isLesionado());
    				...
    				if(time != null){
						...
						AdicionarTime.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
            					...
            					TrabalhoFinalPOO.Collection.Time novo = new Time(time_1.getText());
		...
		btnAdicionar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(timeAmarelo.isSelected()){
					if(!fachada.validarTime("timeAmarelo")){
				...
				if(timeCinza.isSelected()){
					if(!fachada.validarTime("timeCinza")){
				...
				if(timeLaranja.isSelected()){
					fachada.validarTime("timeLaranja");
				}
				if(timeAzul.isSelected()){
					fachada.validarTime("timeAzul");
				}
				if(timeReal.isSelected()){
					fachada.validarTime("timeReal");
				}
				if(timeVasco.isSelected()){
					fachada.validarTime("timeVasco");
				}
				if(timeVerde.isSelected()){
					fachada.validarTime("timeVerde");
				}
				if(timeVermelho.isSelected()){
					fachada.validarTime("timeVermelho");
				}
